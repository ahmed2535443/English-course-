...
export default function EgyptianQA({ question, hint, answer, placeholder, onAnswer }) {
  ...
  return (
    <div className="space-y-4">
      <div className="bg-gradient-to-br from-pink-50 to-fuchsia-50 dark:from-pink-500/10 dark:to-fuchsia-500/10 border border-pink-200 dark:border-pink-500/15 rounded-2xl p-6 text-center">
